 ...
 */
class Squares_Gallery extends Shareprints_Gallery {
	...
	function __construct(){
		// vars
		$this->name = 'squares';
		$this->label = __("Squares",'shareprints');
		$this->defaults = array(
			'sizes' => array(
				'small'  => 'shareprints_thumb',
	...
	function create_gallery( $g ){
		...
		echo '<div class="shareprints_gallery squares '.$g['image_size'].' pad_'.$g['image_padding'].'" data-gallery="'.htmlspecialchars(json_encode($g), ENT_QUOTES, get_bloginfo( 'charset' )).'">';
